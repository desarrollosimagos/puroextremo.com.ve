...
{/if}
	...
	<body>
		<div id="maintenance">
			 ...
			 {$HOOK_MAINTENANCE}
			 <p id="message">
				{l s='Con el fin de realizar el mantenimiento de la página web, nuestra tienda en línea estará temporalmente fuera de línea.'}<br /><br />
				{l s='Pedimos disculpas por las molestias y pedimos que por favor intente de nuevo más tarde.'}
			 </p>
