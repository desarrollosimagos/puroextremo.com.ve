...
{if isset($cms) && !isset($cms_category)}
	{if !$cms->active}
		...
		<div id="admin-action-cms">
			<p>{l s='Esta página CMS no es visible para sus clientes.'}
...
{elseif isset($cms_category)}
	<div class="block-cms">
		...
		{if isset($sub_category) && !empty($sub_category)}	
			<p class="title_block">{l s='Lista de Sub-categorias en %s:' sprintf=$cms_category->name}</p>
			<ul class="bullet">
		...
		<p class="title_block">{l s='Lista de paginas en %s:' sprintf=$cms_category->name}</p>
			<ul class="bullet">
