...
// <![CDATA[
	...
	var txtSelectAnAddressFirst = "{l s='Por favor, comience por seleccionar una dirección' js=1}";
	{/if}
	...
	{
		return {
			'invoice': "{l s='Tu dirección de facturación'}",
			'delivery': "{l s='Tu dirección de entrega'}"
		};
...
{/if}
	<div class="addresses clearfix">
		...
		{else}
			<a href="{$link->getPageLink('address', true, NULL, "back={$back_order_page}?step=1{'&multi-shipping=1'|urlencode}{if $back}&mod={$back}{/if}")|escape:'html'}" title="{l s='Add'}" class="button_large">{l s='Añadir una nueva dirección'}</a>
		{/if}
		</p>
		<div class="clearfix">
		...
		<p class="address_add submit">
			<a href="{$link->getPageLink('address', true, NULL, "back={$back_order_page}?step=1{'&multi-shipping=1'|urlencode}{if $back}&mod={$back|urlencode}{/if}")|escape:'html'}" title="{l s='Add'}" class="button_large">&raquo; {l s='Añadir una nueva dirección'}</a>
		</p>
		{if !$opc}
...
{if !$opc}
	<p class="cart_navigation submit">
		...
		{if $back}
			<a href="{$link->getPageLink('order', true, NULL, "step=0&amp;back={$back}")|escape:'html'}" title="{l s='Previous'}" class="button">&laquo; {l s='Anterior'}</a>
		{else}
			<a href="{$link->getPageLink('order', true, NULL, "step=0")|escape:'html'}" title="{l s='Previous'}" class="button">&laquo; {l s='Anterior'}</a>
		{/if}
