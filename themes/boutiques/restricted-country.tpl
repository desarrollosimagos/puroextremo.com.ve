...
{/if}
	...
	<body>
		<div id="restricted-country">
			 ...
			 <p id="message">
				<img src="{$content_dir}img/admin/tab-tools.gif" style="margin-right:10px; float:left;" alt="" />{l s='No puede acceder a esta tienda en su país. Pedimos disculpas por las molestias.'}
			 </p>
