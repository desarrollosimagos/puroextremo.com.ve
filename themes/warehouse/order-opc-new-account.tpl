		...
		<fieldset>
        	<div class="box">
                ...
                <div id="opc_account_choice" class="row">
                    <div class="quest-checkout-box col-xs-12 col-sm-6">
                        <p class="title_block">{l s='Instant Checkout'}</p>
                        <p class="opc-button">
                            <button type="submit" class="btn btn-default button button-medium exclusive" id="opc_guestCheckout"><span><i class="icon-ok left"></i>{l s='Guest checkout'}</span></button>
                        </p>
                    </div>
