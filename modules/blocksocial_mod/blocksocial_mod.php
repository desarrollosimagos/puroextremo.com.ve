...
class blocksocial_mod extends Module {
	...
	public function getContent() {
		...
		if (isset($_POST['submitModule'])) {
			Configuration::updateValue('bsmod_facebook', (($_POST['bsmod_facebook'] != '') ? $_POST['bsmod_facebook'] : ''));
			Configuration::updateValue('bsmod_twitter', (($_POST['bsmod_twitter'] != '') ? $_POST['bsmod_twitter'] : ''));
			Configuration::updateValue('bsmod_rss', (($_POST['bsmod_rss'] != '') ? $_POST['bsmod_rss'] : ''));
			Configuration::updateValue('bsmod_vimeo', (($_POST['bsmod_vimeo'] != '') ? $_POST['bsmod_vimeo'] : ''));
			Configuration::updateValue('bsmod_youtube', (($_POST['bsmod_youtube'] != '') ? $_POST['bsmod_youtube'] : ''));
			Configuration::updateValue('bsmod_pinterest', (($_POST['bsmod_pinterest'] != '') ? $_POST['bsmod_pinterest'] : ''));
			Configuration::updateValue('bsmod_google', (($_POST['bsmod_google'] != '') ? $_POST['bsmod_google'] : ''));
			Configuration::updateValue('bsmod_instagram', (($_POST['bsmod_instagram'] != '') ? $_POST['bsmod_instagram'] : ''));
			Configuration::updateValue('bsmod_tumblr', (($_POST['bsmod_tumblr'] != '') ? $_POST['bsmod_tumblr'] : ''));
			$this -> _clearCache('blocksocial_mod.tpl');
