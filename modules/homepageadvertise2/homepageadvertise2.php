...
class HomepageAdvertise2 extends Module {
	...
	public function install()
	{
		...
		if (!parent::install() OR !$this->registerHook('home') OR !$this->registerHook('header') OR !$this->registerHook('footerTopBanner'))
			return false;
		...
		if (!Configuration::updateValue($this->name.'_links'	, '')		OR
			...
			!Configuration::updateValue($this->name.'_hook'	, 1)	OR
	...
	function hookHome($params) {
		...
		function hookFooterTopBanner($params) {
