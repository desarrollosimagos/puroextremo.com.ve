	...
	<div class="translatable">
		{foreach $languages as $language}
			<div class="lang_{$language.id_lang}" style="display:{if $language.id_lang == $default_form_language}block{else}none{/if}; float: left;">
				...
				<p class="preference_description">{l s='Specific URL format in block layered generation.' mod='blocklayered_mod'}</p>
	...
	<div class="translatable">
		{foreach $languages as $language}
			<div class="lang_{$language.id_lang}" style="display:{if $language.id_lang == $default_form_language}block{else}none{/if}; float: left;">
				...
				<p class="preference_description">{l s='Specific format for meta title.' mod='blocklayered_mod'}</p>
			</div>
		{/foreach}
	</div>
</div>
