...
* obtain it th-rough the world-wide-web, please send an email
...
<div class="form-group">
	...
	<div class="col-lg-9">
		<div class="row">
			...
			{/foreach}
			<div class="col-lg-9">
				<p class="help-block">{l s='Specific URL format in block layered generation.' mod='blocklayered_mod'}</p>
			</div>
		</div>
	</div>
</div>
<div class="form-group">
	...
	<div class="col-lg-9">
		<div class="row">
			...
			{/foreach}
			<div class="col-lg-9">
				<p class="help-block">{l s='Specific format for meta title.' mod='blocklayered_mod'}</p>
			</div>
		</div>
	</div>
</div>