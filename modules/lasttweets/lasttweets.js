...
"</p>",q&&(b+='<p class="timePosted">'+f[a].innerText+"</p>")):(r&&(b+='<p class="user">'+g[a].textContent+"</p>"),b+='<p class="tweet">'+e[a].textContent+"</p>",q&&(b+='<p class="timePosted">'+f[a].textContent+"</p>"));A&&(b+='<p class="interact"><a href="https://twitter.com/intent/tweet?in_reply_to='+h[a]+'" target="_blank" class="twitter_reply_icon">Reply</a><a href="https://twitter.com/intent/retweet?tweet_id='+h[a]+'" target="_blank" class="twitter_retweet_icon">Retweet</a><a target="_blank" href="https://twitter.com/intent/favorite?tweet_id='+
...
twitterFetcher.fetch(twitter_widgetid, '', twitter_numberoftweets, true, false, true, '', false, handleTweets);
