...
class CsMegaMenu extends Module
{
	...
	public function init_data()
	{
		...
		$option_1 = '{"opt_fill_column":"1","opt_show_parent_cat":"0","opt_show_image_cat":"1","opt_image_size_cate":"category_default","opt_show_sub_cat":"1","opt_show_image_sub_cat":"0","opt_id_parent_cat":"2"}';
		$option_2 = '{"opt_fill_column":"1","opt_show_parent_cat":"0","opt_show_image_cat":"1","opt_image_size_cate":"large_default","opt_show_sub_cat":"0","opt_show_image_sub_cat":"0","opt_id_parent_cat":"3"}';
		$option_3 = '{"opt_fill_column":"1","opt_show_parent_cat":"0","opt_show_image_cat":"0","opt_image_size_cate":"category_default","opt_show_sub_cat":"0","opt_show_image_sub_cat":"0","opt_id_parent_cat":"2"}';
		$option_4 = '{"opt_show_image_product":"1","opt_image_size_product":"home_default","input_hidden_id":"1-2-3-5-","input_hidden_name":"iPod Nano (ref: demo_1)\u00a4iPod shuffle (ref: demo_2)\u00a4MacBook Air (ref: demo_3)\u00a4iPod touch (ref: demo_5)\u00a4","opt_fill_column":"2"}';
		$option_5 = '{&quot;opt_content_static&quot;:{&quot;1&quot;:&quot;&lt;p&gt;Template has a simple-looking, neat, clean layout with blocks of featured products, featured categories and promotions are well-organized on a white background. But this design is highlighted with many new and useful features, becomes one of the most powerful Prestashop templates.&lt;\/p&gt;&quot;,&quot;6&quot;:&quot;&quot;},&quot;opt_fill_column&quot;:&quot;2&quot;}';
		$option_6 = '{"opt_show_image_product":"1","opt_image_size_product":"home_default","input_hidden_id":"6-5-","input_hidden_name":"Belkin Leather Folio for iPod nano - Black \/ Chocolate (ref: demo_6)\u00a4iPod touch (ref: demo_5)\u00a4","opt_fill_column":"2"}';
		$option_7 = '{"checkme_cms":"on","footerBox":["1_1","0_1","0_2","0_3","0_4","0_5"],"opt_fill_column":"1"}';
		$option_8 = '{"opt_fill_column":"1","opt_show_parent_cat":"0","opt_show_image_cat":"1","opt_image_size_cate":"category_default","opt_show_sub_cat":"0","opt_show_image_sub_cat":"0","opt_id_parent_cat":"2"}';
		$option_9 = '{"opt_show_image_manu":"1","opt_image_size_manu":"large_default","opt_show_name_manu":"1","opt_list_manu":["1","2"],"opt_fill_column":"2"}';
		$option_10 = '{"checkme_cms":"on","footerBox":["1_1","0_1","0_2","0_3","0_4","0_5"],"opt_fill_column":"1"}';
		$option_11 = '{&quot;opt_content_static&quot;:{&quot;1&quot;:&quot;&lt;p&gt;Add custom menu with many type dropdown option:&lt;\/p&gt;&lt;ul&gt;&lt;li&gt;Specific Category with thumbnail and sub category with multi level&lt;\/li&gt;&lt;li&gt;Specific Product grid view&lt;\/li&gt;&lt;li&gt;Static block with free content and support multi language&lt;\/li&gt;&lt;li&gt;Grid view image and name Manufacturers&lt;\/li&gt;&lt;li&gt;Specific CMS prestashop page&lt;\/li&gt;&lt;\/ul&gt;&quot;,&quot;6&quot;:&quot;&quot;},&quot;opt_fill_column&quot;:&quot;1&quot;}';
		...
		(2, "'.$id_shop.'", 3, 600, 1, 2),
		(3, "'.$id_shop.'",2, 400, 1, 3),
		(4,"'.$id_shop.'",6, 1180, 1, 4),
		(5, "'.$id_shop.'",2, 400, 1, 5),
		(6, "'.$id_shop.'",1, 200, 1,7),
		(7, "'.$id_shop.'",1, 350, 1, 7);') OR
		...
		!Db::getInstance()->Execute("INSERT INTO `"._DB_PREFIX_."csmegamenu_lang` (`id_csmegamenu`, `id_lang`, `id_shop`, `title`, `link_of_title`, `description`) VALUES 
			(1, '".$id_en."', '".$id_shop."', 'Home','{megamenu_url}index.php', ''),
			(1, '".$id_fr."', '".$id_shop."', 'Maison', '{megamenu_url}index.php', ''),
			(2, '".$id_en."', '".$id_shop."', 'Categories', '{megamenu_url}index.php?id_category=3&controller=category&id_lang=1', ''),
			(2, '".$id_fr."', '".$id_shop."', 'Catégories', '{megamenu_url}index.php?id_category=3&controller=category&id_lang=2', ''),
			(3, '".$id_en."', '".$id_shop."', 'Product', '{megamenu_url}index.php?id_product=1&controller=product&id_lang=1', ''),
			(3, '".$id_fr."', '".$id_shop."', 'Produit', '{megamenu_url}index.php?id_product=1&controller=product&id_lang=2', ''),
			(4, '".$id_en."', '".$id_shop."', 'Combination', '#', ''),
			(4, '".$id_fr."', '".$id_shop."', 'Combinaison', '#', ''),
			(5, '".$id_en."', '".$id_shop."', 'Manufacture', '{megamenu_url}index.php?controller=manufacturer', ''),
			(5, '".$id_fr."', '".$id_shop."', 'Manufacture', '{megamenu_url}index.php?controller=manufacturer', ''),
			(6, '".$id_en."', '".$id_shop."', 'CMS', '{megamenu_url}index.php?id_cms_category=1&controller=cms&id_lang=1', ''),
			(6, '".$id_fr."', '".$id_shop."', 'CMS', '{megamenu_url}index.php?id_cms_category=1&controller=cms&id_lang=2', ''),
			(7, '".$id_en."', '".$id_shop."', 'Text', '#', ''),
			(7, '".$id_fr."', '".$id_shop."', 'Text', '#', '');"		
		) OR
		...
		VALUES 
			...
			(3, 2, 0, 0, '".$option_3."'),
			(4, 3, 1, 0, '".$option_4."'),
			(5, 4, 2, 0,'".pSQL($option_5)."'),
			(6, 4, 1, 2, '".$option_6."'),
			(7, 4, 4, 3,'".$option_7."'),
			(8, 4, 0, 0,'".$option_8."'),
			(9, 5, 3, 0,'".$option_9."'),
			(10, 6, 4, 0,'".$option_10."'),
			(11,7, 2, 0,'".pSQL($option_11)."');") OR
		...
		!Db::getInstance()->Execute("INSERT INTO `"._DB_PREFIX_."csmegamenu_option_shop` (`id_option`, `id_csmegamenu`, `id_shop`, `type_option`, `position_option`, `content_option`)
			VALUES 
			(1, 2, '".$id_shop."', 0, 0,'".$option_1."'),
			(2, 2, '".$id_shop."', 0, 1, '".$option_2."'),
			(3, 2, '".$id_shop."', 0, 0, '".$option_3."'),
			(4, 3, '".$id_shop."', 1, 0, '".$option_4."'),
			(5, 4, '".$id_shop."', 2, 0, '".pSQL($option_5)."'),
			(6, 4, '".$id_shop."', 1, 2, '".$option_6."'),
			(7, 4, '".$id_shop."', 4, 3, '".$option_7."'),
			(8, 4, '".$id_shop."', 0, 0, '".$option_8."'),
			(9, 5, '".$id_shop."', 3, 0, '".$option_9."'),
			(10, 6, '".$id_shop."', 4, 0, '".$option_10."'),
			(11, 7, '".$id_shop."', 2, 0, '".pSQL($option_11)."');"))
			return false;
		return true;
	}
	...
	function install()
	{
		if (!parent::install() || !$this->registerHook('header')|| !$this->registerHook('csmegamenu') ||
			...
			return false;
		/*Update postion for hook*/
		$id_hook = Hook::getIdByName('csmegamenu');
		if(isset ($id_hook) && $id_hook)
		{
			$new_hook = new Hook($id_hook);
			$new_hook->position = 1;
			$new_hook->update();
		}
	...
	private function _displayAddOptionForm()
	{
		global $currentIndex, $cookie;
		$menus = $this->getMenus();
		$menu_item = new CsMegaMenuClass(Tools::getValue('id_csmegamenu'));
		$this->_html .= '
		...
		<input type="hidden" name="id_csmegamenu" value="'.Tools::getValue('id_csmegamenu').'"/>
		<div class="div_select_option">
					<div id="div_select_option">
					<p>
					<label>'.$this->l('Add for menu').'</label>
						<select name="id_csmegamenu" style="width:250px;" >';
					foreach ($menus AS $menu){
						$this->_html .= '<option value="'.$menu['id_csmegamenu'].'">'.$menu['id_csmegamenu'].' - '.$menu['title'].'</option>';
					}
					$this->_html .= '
						</select>
					</p>
			...
			<div class="div_content_option">
				<div class="option_type_0">
					<p>
					<label>'.$this->l('Show Name Parent Category:').'</label> 
					...
					<p>
					<label>'.$this->l('Show Image Parent Category:').'</label> 
				...
				$this->_html .= '</select></p>
					...
					<p>
					<label>'.$this->l('Show Image Sub Category:').'</label> 
					<input class="opt_show_sub_cat" name="content_option[0][opt_show_image_sub_cat]" type="radio" value="1"'.(Tools::getValue('opt_show_image_sub_cat',1) ? 'checked="checked"' : '').' />
					<label class="t"><img src="'._PS_ADMIN_IMG_.'enabled.gif" alt="Enabled" title="Enabled" /></label>
					<input class="opt_show_sub_cat" name="content_option[0][opt_show_image_sub_cat]" type="radio" value="0"'.(Tools::getValue('opt_show_image_sub_cat',1) ? '' : 'checked="checked"').' />
					<label class="t"><img src="'._PS_ADMIN_IMG_.'disabled.gif" alt="Disabled" title="Disabled" /></label></p>';
					$cate_selected = array();
					$helper = new Helper();
	...
	public function _displayMenuCategories()
	{
		...
		if (is_array($menus))
		{
			foreach ($menus as $menu)
			{
				...
				<td><div class="categorieWidth" id="categorieWidth'.$menu['id_csmegamenu'].'" onclick="$(\'.categorieWidth\').css(\'font-weight\',\'normal\');$(this).css(\'font-weight\',\'bold\');return ajaxLoadMenu('.$menu['id_csmegamenu'].');"><a class="upper" href="#">'.$menu['title'].'</a></div></td>
				...
				<td><b><img style="cursor:pointer" title="'.$this->l('Show option').'" id="image_more_options'.$menu['id_csmegamenu'].'" src="../img/admin/more.png" alt="'.$this->l('show Options').'" 
					onclick="if ($(\'#option_menu_'.$menu['id_csmegamenu'].'\').is(\':visible\'))$(this).attr(\'src\', \'../img/admin/more.png\'); else $(this).attr(\'src\', \'../img/admin/less.png\');$(\'#option_menu_'.$menu['id_csmegamenu'].'\').slideToggle(\'fast\');" /></b></td>
				</tr>';
				$menu_item = new CsMegaMenuClass($menu['id_csmegamenu']);
				$options_list = $menu_item->getOptionForMenu();
				$html .= '
							...
							foreach ($this->optionsMenu as $k=>$ot)
							{
								if($k == $option['type_option'])
								{
									$html .='<td class="pointer dragHandle center">'.($option !== end($options_list) ? '
										...
										<td><a href="'.$currentIndex.'&configure='.$this->name.'&token='.Tools::getAdminTokenLite('AdminModules').'&editOptionMenu&id_option='.$option['id_option'].'&id_csmegamenu='.$menu['id_csmegamenu'].'&type_option='.$option['type_option'].'"><span>'.$number++.' - '.$this->l('Optiton ').''.$ot.' (#'.$option['id_option'].')</span></a></td>';
									break; 
								}
							}
	...
	private function _displayUpdateOptionForm()
	{
		...
		<div class="div_select_option">
					...
					<label>'.$this->l('Menu').'</label>
						<select name="id_csmegamenu" style="width:250px;" >';
					foreach ($menus AS $menu){
						$this->_html .= '<option '.(isset($option->id_csmegamenu) && $option->id_csmegamenu == $menu['id_csmegamenu'] ? "selected=\"selected\"" : "" ).' value="'.$menu['id_csmegamenu'].'">'.$menu['id_csmegamenu'].' - '.$menu['title'].'</option>';
					}
					$this->_html .= '
						</select>
					</p>
			...
			<div class="div_content_option">
				...
				<p>
					<label>'.$this->l('Show Image Sub Category:').'</label> 
					<input class="opt_show_image_sub_cat" name="content_option[0][opt_show_image_sub_cat]" type="radio" value="1"';
					if(isset($option->content_option->opt_show_image_sub_cat))
						if($option->content_option->opt_show_image_sub_cat == 1)
							$this->_html .= 'checked="checked"';
					$this->_html .= ' />
					<label class="t"><img src="'._PS_ADMIN_IMG_.'enabled.gif" alt="Enabled" title="Enabled" /></label>
					<input class="opt_show_image_sub_cat" name="content_option[0][opt_show_image_sub_cat]" type="radio" value="0"';
					if(isset($option->content_option->opt_show_image_sub_cat))
						if($option->content_option->opt_show_image_sub_cat == 0)
							$this->_html .= 'checked="checked"';
					$this->_html .= '/>
					<label class="t"><img src="'._PS_ADMIN_IMG_.'disabled.gif" alt="Disabled" title="Disabled" /></label></p>';
	...
	private function _displayForm()
	{
		...
		// Language 
	 	$defaultLanguage = (int)(Configuration::get('PS_LANG_DEFAULT'));
		$languages = Language::getLanguages(false);
		$divLangName = 'titlediv¤descriptiondiv¤link_of_titlediv';
	 	$this->_html .= '<div style="overflow:hidden"><div class="sidebar" style="width:35%">';
		...
		<div id="moduleContainer">
			...
			<legend>'.$this->l('Creat New Menu').'</legend>
				...
				<div class="margin-form">';
					...
					{
						$this->_html .= '
					<div id="link_of_titlediv_'.$language['id_lang'].'" style="display: '.($language['id_lang'] == $defaultLanguage ? 'block' : 'none').'; float: left;">
						<input type="text" name="link_of_title_'.$language['id_lang'].'" value="'.Tools::getValue('link_of_title_'.$language['id_lang']).'" size="55" /><sup> *</sup>
					</div>';
					}
					$this->_html .= $this->displayFlags($languages, $defaultLanguage, $divLangName, 'link_of_titlediv', true);
	...
	public function _displayUpdateForm($id_csmegamenu) //used
	{
		global $currentIndex, $cookie;
		if (!$id_csmegamenu)
		{
		...
		<fieldset>
			<legend><img src="'.$this->_path.'logo.gif" alt="" title="" /> '.$this->l('Update menu ').$menu->title[$defaultLanguage].'</legend>
				<input type="hidden" value="'.$menu->id_csmegamenu.'" name="id_csmegamenu"/>
				<label>'.$this->l('Title:').'</label>
				<div class="margin-form">';
					foreach ($languages as $language)
					{
				...
				foreach ($languages as $language)
				{
					$this->_html .= '
				<div id="link_of_titlediv_'.$language['id_lang'].'" style="display: '.($language['id_lang'] == $defaultLanguage ? 'block' : 'none').'; float: left;">
					<input type="text" name="link_of_title_'.$language['id_lang'].'" value="'.(isset($menu->link_of_title[$language['id_lang']]) ? $menu->link_of_title[$language['id_lang']] : '').'" size="55" /><sup> *</sup>
				</div>';
				}
				$this->_html .= $this->displayFlags($languages, $defaultLanguage, $divLangName, 'link_of_titlediv', true);
	...
	private function _postProcess()
	{
		...
		elseif (Tools::isSubmit('saveMenu'))
		{
			...
			{
				Tools::getValue('id_csmegamenu') ? $mg_menu->update() : $mg_menu->add();
				$this->_clearCache('csmegamenu.tpl');
	...
	public function getContent()
   	{
		...
		<script type="text/javascript">
					function ajaxLoadMenu(id_csmegamenu)
					{
						$.ajax({
						type: \'post\',
						url: \''.__PS_BASE_URI__.'\' + \'modules/csmegamenu/csmegamenu_ajax.php\',
						data: \'&id_csmegamenu=\' + id_csmegamenu,
		...
		elseif (Tools::isSubmit('editOptionMenu'))
		{
			...
			<script type="text/javascript">
				$(document).ready(function() {
					$("#option_menu_'.Tools::getValue('id_csmegamenu').'").show();
					$("#image_more_options'.Tools::getValue('id_csmegamenu').'").attr(\'src\', \'../img/admin/less.png\');
					$("#option_menu_'.Tools::getValue('id_csmegamenu').' #option'.Tools::getValue('id_csmegamenu').'_'.Tools::getValue('id_option').'").css("font-weight","bold");
					$("#categorieWidth'.Tools::getValue('id_csmegamenu').'").css("font-weight","bold");
				});</script>
			';
