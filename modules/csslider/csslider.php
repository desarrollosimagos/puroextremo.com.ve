...
class CsSlider extends Module
{
	...
	private $easing = array("easeOutBack","easeInQuad","easeOutQuad","easeInOutQuad","easeInCubic","easeOutCubic","
	...
	public function init_data()
	{
		...
		$caption = "<div class=''content_slider''> <p class=''manufacter''>chanel presents</p> <h4><span>a weapon</span> for gentelmen<a class=''s_bt_b_color''> shop now</a> </h4> </div>";
		
		if(!Db::getInstance()->Execute('INSERT INTO `'._DB_PREFIX_.'csslider` (`id_slider`, `url`, `animation`, `image`, `position`, `display`) VALUES 
		(1, "#",\'{"transitions":"random","slotamount":"5","masterspeed":"1000","target":"_blank","delay":"6000","enablelink":"1","enablefullvideo":"1"}\',\'{"type":"image","value":"1.jpg"}\', 0, 1),
		(2, "#", \'{"transitions":"random","slotamount":"5","masterspeed":"1000","target":"_self","delay":"6000","enablelink":"1","enablefullvideo":"1"}\', \'{"type":"image","value":"2.jpg"}\', 3, 1),
		(3, "#", \'{"transitions":"random","slotamount":"5","masterspeed":"1000","target":"_self","delay":"6000","enablelink":"1","enablefullvideo":"1"}\', \'{"type":"image","value":"3.jpg"}\', 2, 1),
		(4, "#", \'{"transitions":"random","slotamount":"5","masterspeed":"1000","target":"_self","delay":"6000","enablelink":"1","enablefullvideo":"1"}\', \'{"type":"image","value":"4.jpg"}\', 1, 1),
		(5, "#", \'{"transitions":"random","slotamount":"5","masterspeed":"1000","target":"_self","delay":"6000","enablelink":"1","enablefullvideo":"1"}\', \'{"type":"image","value":"5.jpg"}\', 4, 1);
		') OR
		...
		(1, "'.$id_shop.'","#",\'{"transitions":"random","slotamount":"5","masterspeed":"1000","target":"_blank","delay":"6000","enablelink":"1","enablefullvideo":"1"}\',\'{"type":"image","value":"1.jpg"}\', 0, 1),
		(2,"'.$id_shop.'", "#", \'{"transitions":"random","slotamount":"5","masterspeed":"1000","target":"_self","delay":"6000","enablelink":"1","enablefullvideo":"1"}\', \'{"type":"image","value":"2.jpg"}\', 3, 1),
		(3,"'.$id_shop.'", "#", \'{"transitions":"random","slotamount":"5","masterspeed":"1000","target":"_self","delay":"6000","enablelink":"1","enablefullvideo":"1"}\', \'{"type":"image","value":"3.jpg"}\', 2, 1),
		(4,"'.$id_shop.'", "#", \'{"transitions":"random","slotamount":"5","masterspeed":"1000","target":"_self","delay":"6000","enablelink":"1","enablefullvideo":"1"}\', \'{"type":"image","value":"4.jpg"}\', 1, 1),
		(5,"'.$id_shop.'", "#", \'{"transitions":"random","slotamount":"5","masterspeed":"1000","target":"_self","delay":"6000","enablelink":"1","enablefullvideo":"1"}\', \'{"type":"image","value":"5.jpg"}\', 4, 1);
		') OR
		
		!Db::getInstance()->Execute('INSERT INTO `'._DB_PREFIX_.'csslider_caption` (`id_caption`, `id_slider`, `layer`, `content`) VALUES 
		(1, 1, 0, \'{"type_caption":"imagecaption","datax":"20","datay":"20","class":"medium_text","dataspeed":"300","datastart":"800","incomanimation":"randomrotate","outgoanimation":"randomrotateout","easing":"easeOutExpo","endeasing":"easeInExpo","image_1":"1_1.png","image_2":"1_1.png"}\'),
		(3, 1, 1, \'{"type_caption":"imagecaption","datax":"20","datay":"540","class":"big_white","dataspeed":"600","datastart":"1300","incomanimation":"randomrotate","outgoanimation":"randomrotateout","easing":"easeOutBack","endeasing":"easeInExpo","image_1":"3_1.png","image_2":"3_1.png"}\'),
		(4, 4, 2, \'{"type_caption":"imagecaption","datax":"780","datay":"140","class":"large_text","dataspeed":"300","datastart":"500","incomanimation":"randomrotate","outgoanimation":"randomrotateout","easing":"easeInOutQuad","endeasing":"easeInCirc","image_1":"4_1.png","image_2":"4_1.png"}\'),
		(5, 4, 3, \'{"type_caption":"imagecaption","datax":"780","datay":"385","class":"medium_text","dataspeed":"300","datastart":"800","incomanimation":"lfb","outgoanimation":"stt","easing":"easeInQuint","endeasing":"easeOutBack","image_1":"5_1.png","image_2":"5_1.png"}\'),
		(6, 3, 4, \'{"type_caption":"imagecaption","datax":"30","datay":"130","class":"large_text","dataspeed":"600","datastart":"100","incomanimation":"lfl","outgoanimation":"fadeout","easing":"easeOutExpo","endeasing":"easeInQuart","image_1":"6_1.png","image_2":"6_1.png"}\'),
		(7, 2, 5, \'{"type_caption":"imagecaption","datax":"780","datay":"140","class":"large_text","dataspeed":"600","datastart":"100","incomanimation":"randomrotate","outgoanimation":"ltt","easing":"easeInOutQuint","endeasing":"easeOutBounce","image_1":"7_1.png","image_2":"7_1.png"}\'),
		(8, 2, 6, \'{"type_caption":"imagecaption","datax":"780","datay":"385","class":"large_text","dataspeed":"600","datastart":"100","incomanimation":"lfb","outgoanimation":"str","easing":"easeInQuint","endeasing":"easeOutBack","image_1":"8_1.png","image_2":"8_1.png"}\'),
		(9, 5, 7, \'{"type_caption":"imagecaption","datax":"40","datay":"270","class":"large_text","dataspeed":"600","datastart":"100","incomanimation":"sfr","outgoanimation":"stt","easing":"easeInQuad","endeasing":"easeOutBack","image_1":"9_1.png","image_2":"9_1.png"}\');
		')
		)
			return false;
		return true;
	...
	private function _displayOptions()
	{
		...
		<form method="post" action="'.Tools::safeOutput($_SERVER['REQUEST_URI']).'" enctype="multipart/form-data">
			...
			<label>'.$this->l('FullWidth:').'</label>
			<div class="margin-form">
				<input type="radio" name="fullwidth" value="on" '.($option->fullwidth == "on" ? 'checked="checked"' : '').' />
				<label class="t"><img src="'._PS_ADMIN_IMG_.'enabled.gif" alt="Enabled" title="Enabled" /></label>
				<input type="radio" name="fullwidth" value="off" '.($option->fullwidth == "off" ? 'checked="checked"' : '').' />
				<label class="t"><img src="'._PS_ADMIN_IMG_.'disabled.gif" alt="Disabled" title="Disabled" /></label>
				<p class="clear">'.$this->l('Stop the Timer when hovering the slider').'</p>
				<div class="clear"></div>
			</div>
			...
			foreach ($sliders as $slider)
			{
				...
				<tr class="'.($irow++ % 2 ? 'alt_row' : '').'">
					...
					if(isset($bg_slider->type) && $bg_slider->type == "color")
						$this->_html .= '<div style="width:45px;height:45px;background-color:'.$bg_slider->value.'"></div>';
	...
	private function _displayAddForm()
	{
		...
		// Form
		$this->_html .= '
		<h2><img src="'.$this->_path.'logo.gif" alt="" title="" /> '.$this->l('New Slider').'</h2>
		...
		<ul class="tab">
			...
			<fieldset class="general tab-manager plblogtabs">
				...
				<div class="animation" id="animation_color" style="display:none">
					<div class="margin-form">
						<input id="result_animation_colobg" name="image[value]" type="text"/> 
	...
	private function _displayUpdateForm()
	{
		...
		<ul class="tab">
			...
			<fieldset class="general tab-manager plblogtabs">
				...
				<div class="margin-form">
					...
					<input type="file" name="image[value]" /><sup> *</sup>';
					if ($dot_pos = strrpos($slider->image->value,'.'))
						$thumb_url = _PS_BASE_URL_._MODULE_DIR_.$this->name.'/images/thumbs/'.substr($slider->image->value, 0, $dot_pos).substr($slider->image->value, $dot_pos);
					else
						$thumb_url =_PS_BASE_URL_._MODULE_DIR_.$this->name.'/image/default_thumb.jpg';
				...
				<div class="animation" id="animation_color" '.($slider->image->type == "color" ? '' : 'style="display:none"').'>
					<div class="margin-form">
						<input '.($slider->image->type == 'color' ? 'style="background-color:'.$slider->image->value.'"' : '').' value="'.($slider->image->type == 'color' ? $slider->image->value : '').'" id="result_animation_colobg" name="image[value]" type="text"/> 
						<span id="animation_colobg" style="cursor:pointer">
						<img src="'._PS_ADMIN_IMG_.'color.png"/>
						</span>
					</div>
		...
		<fieldset class="caption tab-manager plblogtabs">
			...
			<label style="width:150px">'.$this->l('Video ID:').'</label>';
				...
				<div style="float:right;width:340px"><h4>'.$this->l('List caption').'</h4>
				<script type="text/javascript">
	...
	{
		//duplicate slideshow for shop
		Db::getInstance()->execute('
		INSERT IGNORE INTO '._DB_PREFIX_.'csslider_shop (`id_slider`, `id_shop`, `url`, `animation`, `image`, `position`, `display`)
		SELECT id_slider, '.(int)$params['new_id_shop'].', url, animation, image,position,display 
