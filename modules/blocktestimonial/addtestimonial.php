	...
	if (intval(Configuration::get('TESTIMONIAL_CAPTCHA')) ) // if we need to use a recaptcha
                     {
                      ...
                      if (isset($_POST["recaptcha_response_field"])) $recaptcha_challenge_field = $_POST["recaptcha_response_field"];
...
$smarty->assign('allowupload', Configuration::get('TESTIMONIAL_DISPLAY_IMG'));
