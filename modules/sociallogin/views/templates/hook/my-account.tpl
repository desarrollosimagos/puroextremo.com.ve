...
<li class="favoriteproducts">
	<a href="{$link->getModuleLink('sociallogin', 'account')|escape:'htmlall':'UTF-8'}" title="{l s='Social Account Linking' mod='sociallogin'}">
		{if !$in_footer}<i> <img {if isset($mobile_hook)}src="{$module_template_dir|escape:'htmlall':'UTF-8'}img/socialinking.jpg" class="ui-li-icon ui-li-thumb"{else}src="{$module_template_dir|escape:'htmlall':'UTF-8'}img/socialinking.jpg" class="icon"{/if} alt="{l s='Social Account Linking' mod='sociallogin'}"/></i>{/if}
